...
Собирает информацию записей журнала и в режиме добровольного обмена информацией синхронизирует ее с внешними научными службами, такими, как [база данных Canonn](https://api.canonn.tech/documentation) и [база данных ATEL-IGAU](https://github.com/Elite-IGAU/ATEL-EDMC).
