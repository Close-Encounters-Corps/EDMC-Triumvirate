...
def plugin_prefs(parent, cmdr, is_beta):
   ...
   # entry=nb.Entry(frame,None)
    nb.Label(frame,text=_("In case of problems with the plugin \nor if you put the wrong community in google form, \nping me in Discord PM ")).grid(row=9,column=0,sticky="NW")  #В случае возникновения проблем с плагином \nили в случае, если Вы поставили неправильное сообщество в гугл форме, \nпишите в личку Дискорда Казаков#4700
