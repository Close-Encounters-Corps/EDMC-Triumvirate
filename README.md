...
## Элемент по передаче запроса о дозаправке

После того, как пилот напишет в чате игры команду "!sos", плагином будет сформирован и передан в чат Close Encounters Corps (специально выделенный канал) пакет данных с местоположением, количеством топлива, местом и временем. Благодаря этим данным пилоту, попавшему в опасную ситацию можно будет своевремнно довезти топливо и произвести дозаправку.
