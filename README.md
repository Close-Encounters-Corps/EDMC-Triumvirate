...
Инструкция по установке
   ...
   5)Запустить EDMC, если появилось окно такого вида !(https://github.com/VAKazakov/EDMC-Triumvirate/blob/master/.vs/EDMC-Main.PNG" "), то перейти к шагу 6, иначе проверить правильность установки